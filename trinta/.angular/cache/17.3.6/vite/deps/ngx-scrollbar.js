...
_NgScrollbarCore.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    ...
    buttons: [InputFlags.SignalBased, "buttons"],
    ...
    trackScrollDuration: [InputFlags.HasDecoratorInputTransform, "trackScrollDuration", "trackScrollDuration", numberAttribute],
...
_ScrollbarY.ɵcmp = ɵɵdefineComponent({
  ...
  template: function ScrollbarY_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      ɵɵadvance();
      ɵɵconditional(5, ctx.cmp.buttons() ? 5 : -1);
    }
  },
...
_NgScrollbarExt.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    skipInit: [InputFlags.HasDecoratorInputTransform, "skipInit", "skipInit", booleanAttribute]
  },
  exportAs: ["ngScrollbar"],
  standalone: true,
  features: [ɵɵProvidersFeature([{
